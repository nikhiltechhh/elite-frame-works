        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl">
              Join the ultimate gaming experience. Watch live tournaments, connect with pro players, and dominate the leaderboards.
            </p>
            ...
            <div className="flex flex-wrap gap-8 pt-8">
              ...
              <div className="space-y-1">
                <div className="text-3xl md:text-4xl font-bold text-primary text-glow">500+</div>
                <div className="text-sm text-muted-foreground uppercase tracking-wider">Tournaments</div>
              </div>
              <div className="space-y-1">
                <div className="text-3xl md:text-4xl font-bold text-primary text-glow">$2M+</div>
